    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-base sm:text-lg font-semibold text-primary-200 mb-3 uppercase tracking-widest">
              Über uns
            </p>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Von Tiermenschen für Tiermenschen
            </h1>
            <p className="text-xl max-w-2xl mx-auto leading-relaxed text-primary-50">
      ...
      <div className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl space-y-6">
            <h2 className="text-3xl font-bold text-gray-900">Wie alles begann</h2>
          ...
          <div className="mt-12 lg:mt-16">
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-3 sm:gap-6 lg:gap-8 xl:gap-10">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
            {[
              ...
              <div key={item} className="flex items-center gap-3 bg-primary-50 rounded-lg px-4 py-3">
                <GraduationCap className="h-5 w-5 text-primary-600 shrink-0" />
      ...
      <div className="py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Wofür wir stehen</h2>
          </div>
      ...
      <div className="bg-white border-t border-gray-100 py-16">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Schreib uns</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="mailto:info@tigube.de" className="btn btn-primary">
              info@tigube.de
            </a>
